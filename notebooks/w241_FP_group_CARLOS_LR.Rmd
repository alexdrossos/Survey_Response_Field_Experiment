...
tab02 <- kable(
  ...
  caption = "Power Calculation:") %>%
  footnote(
    general = "5 dollar Incentive vs. 100 dollar Lottery.",
    general_title = "Note.",
    footnote_as_chunk = TRUE)
```
...
df_ttest <- data.frame(
  column_name = c("No Treatment vs. $5 Incentive", "No Treatment vs. $100 Lottery", "5 dollar Incentive vs. 100 dollar Lottery"),
...
Table __ gives the response rate by 
...
> Randomization was successful because the covariate balance check reveals that the proportion of observations in the Pacific Timezone does not differ statistically significantly between the control group, given no incentive for survey completion, and the `$5 Incentive` treatment group, since the covariate balance check does not have a statistically significant coefficient for `$5 Incentive`.
